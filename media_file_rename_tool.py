...
def store_extensions():
	...
	print('The extension sucessfully added. Do you want to add another extension? (Y/N)')
...
def rename_files(directory='./', extensions=None):
	...
	for file in file_list:
		...
		if (extension in extensions):
			...
			# Add an order number to the name if there is other file created at the same timestamp
